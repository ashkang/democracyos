...
const extEntries = require('lib/ext/entries')
...
gulp
  ...
  .task('css:watch', ['css:build', 'css:buildRtl'], css.watch)
  .task('css:buildRtl', css.buildRtl)
  ...
  .task('build', ['js:build', 'css:build', 'css:buildRtl', 'assets'])
