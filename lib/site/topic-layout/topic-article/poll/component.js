...
const Option = ({
  ...
  const percentageL10n = percentage ? percentage.toLocaleString(config.locale) : Number(0).toLocaleString(config.locale)
  ...
  return (
    ...
    {showResults && <span className='poll-results'>٪{ percentageL10n }</span>}
